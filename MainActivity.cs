...
{
    [Activity(Label = "@string/app_name",  MainLauncher = true)]  // Theme = "@style/Theme.XamarinBasicSplashScreen.NoActionBar", - Removed because of SplashScreen API - see how the theme is set in the AndroidManifest.xml
